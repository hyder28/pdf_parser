...
- **Text Content Detection:** Extract span level information (bbox, text, size, style, color, font, page no) on the page using PyMuPDF. Use rectangle coordinates from paragraph detection, to assign span texts to be within respective paragraphs. Assign title and text labels based on text attributes (font, size, style).
